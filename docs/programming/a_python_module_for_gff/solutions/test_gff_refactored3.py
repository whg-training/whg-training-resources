...
class TestGff(unittest.TestCase):
	...
	def test_remove_value_from_attributes( self ):
		...
		assert gff.remove_value_from_attributes( "a=b;c=d;ID=test_value", "c" ) == "a=b;ID=test_value"
		assert gff.remove_value_from_attributes( "a=b;ID=test_value", "Parent" ) == "a=b;ID=test_value"
		assert gff.remove_value_from_attributes(
		  "ID=ENST00000456328.2;Parent=ENSG00000223972.5;gene_type=transcribed_unprocessed_pseudogene",
		  "ID"
		) == "Parent=ENSG00000223972.5;gene_type=transcribed_unprocessed_pseudogene"
		assert gff.remove_value_from_attributes(
		  "ID=ENST00000456328.2;Parent=ENSG00000223972.5;gene_type=transcribed_unprocessed_pseudogene",
		  "gene_type"
