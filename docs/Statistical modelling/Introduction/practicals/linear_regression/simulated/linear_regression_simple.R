...
# How to diagnose?
# Let's make a quantile-quantile plot showing
# the actual residuals against the expected residuals.
# (If the linear model is true, then the residuals should be like a Gaussian with the given
# variance.  So we can plot them against quantiles of the Gaussian.)
